...
| :----------- | -------- | ----------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 获取书籍列表 | *        | /api/get/booklist | *                                                            | [<br/>    {<br/>        "bookId": 10000001,<br/>        "name": "大雪中的山庄",<br/>        "author": "东野圭吾 ",<br/>        "publish": "北京十月文艺出版社",<br/>        "isbn": "9787530216835",<br/>        "introduction": "东野...",<br/>        "language": "中文",<br/>        "price": 35,<br/>        "pubdate": "2017-06-01",<br/>        "classId": 9,<br/>        "pressmark": 13,<br/>        "state": 1<br/>    }] |
